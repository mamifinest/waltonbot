...
//GENEL KOMUTU
  ...
  .setFooter('Bu komutu kullanan kullanıcı ' + message.author.tag, message.author.displayAvatarURL())
   .setDescription(client.commands.filter(cmd => cmd.conf.kategori === 'Genel').map(cmd => `:white_small_square: - **${prefix}${cmd.help.name}** ${cmd.help.description}`).join("\n "))
        .addField("» DEVELOPMENT", ` [Ash Development](https://discord.gg/FXaMUSRm)`, false)
  ...
  .setFooter('Bu komutu kullanan kullanıcı ' + message.author.tag, message.author.displayAvatarURL())
   .setDescription(client.commands.filter(cmd => cmd.conf.kategori === 'Sunucu').map(cmd => `:white_small_square: - **${prefix}${cmd.help.name}** ${cmd.help.description}`).join("\n "))
        .addField("» Linkler", ` [Ash Development](https://discord.gg/FXaMUSRm)`, false)
...
//YARDIM KOMUTU
  ...
  **[${prefix}yardım Genel](https://discord.gg/2hSKZrWepz)** 
  **[${prefix}yardım Eğlence](https://discord.gg/2hSKZrWepz)**
  **[${prefix}yardım Moderasyon](https://discord.gg/2hSKZrWepz)**
  **[${prefix}yardım Sunucu](https://discord.gg/2hSKZrWepz)**
  **[${prefix}yardım Sahip](https://discord.gg/2hSKZrWepz)**
  `)
  .addField("» Linkler", ` [Ash Development](https://discord.gg/FXaMUSRm)`, false)
